...
myLayout = toggleLayouts (noBorders Full) (onWorkspaces [Custom.MyVariables.webWS, Custom.MyVariables.fireWS] (tabbed shrinkText Custom.MyVariables.myTabConfig) tiled ||| Mirror tiled)
  where
